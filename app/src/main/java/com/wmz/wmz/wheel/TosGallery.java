...
public class TosGallery extends TosAbsSpinner implements
	...
	protected boolean getChildStaticTransformation(View child, Transformation t) {
		...
		if (child == mSelectedChild) {
			t.setAlpha(1.0f);
			((WheelTextView)child).setTextColor(0xFF099DF5);//��ɫ
			((WheelTextView) child).setTextSize(20);
		} else {
			((TextView)child).setTextColor(0xFF000000);
			t.setAlpha(mUnselectedAlpha);
		}
	 ...
	 * 
	 * @param firstChildOffset
	 *            The value of first child offset.
	 * 
	 * @author LeeHong
	 */
	 ...
	 * 
	 * @param listener
	 *            The OnEndFlingListener instance.
	 * 
	 * @author LeeHong
	 */
	 ...
	 * 
	 * @param disableScroll
	 *            true if disable the scroll action, otherwise false, default
	 *            false.
	 * 
	 * @author LeeHong
	 */
	 ...
	 * 
	 * @param toLeft
	 *            Indicate offset towards left or right.
	 * 
	 ...
	 * 
	 * @param x
	 *            The x coordinate to the gallery.
	 * @param y
	 *            The y coordinate to the gallery.
	 * 
